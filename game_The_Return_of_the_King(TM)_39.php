<HTML>
<HEAD>
<TITLE>The Lord Of The Rings: TheReturn of the King</TITLE>
...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=39#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=39", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">The Lord Of The Rings: TheReturn of the King</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1">Lead Aragorn in to a battle for the survival of Middle-earth <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_39/image_02_jeu.jpg" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=39','','width=250,height=250')"><img src="admin/Jeu/jeu_39/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=39','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">This single player side-scrolling fighting and adventure game is filled with daunting challenges, and fierce battles. Lead Aragorn in to a battle for the survival of Middle-earth. To progress through each of the 6 levels, users must face down the enemies.</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>
<DIV class='gamefeatures'><FONT class='gamefeatures'><FONT class='gamefeatures'>Be Aragorn, the hero of The Lord of the Rings Trilogy</FONT></FONT></DIV>
<LI class='gamefeatures'>
<DIV class='gamefeatures'><FONT class='gamefeatures'><FONT class='gamefeatures'>Relive the best sequence of the movie</FONT></FONT></DIV>
<LI class='gamefeatures'>
<DIV class='gamefeatures'>6 levels to face Orcs, Uruk-hai, The Army of the Dead</DIV></LI></UL> <br>
			   <P class='gamefeatures'><STRONG>Only available on ExEn phones.</STRONG></P> <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=39','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_39/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_39/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_39/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td nowrap class="rate">Kazeem Oluwatobi 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink"> (Australia) 2004-11-02 12:56:47</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">I love the interest of it	<br>
                      </td>
                    </tr>
                    <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td rowspan="4"><img src="images/spacer.gif" width="5" height="1"></td>
                      <td nowrap class="rate">cristian 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink">  2004-10-06 08:58:23</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td width="100%" nowrap class="newsteaser"><table width="1%" border="0" cellspacing="2" cellpadding="0">
                        <tr>
                      <td><img src="images/p_etoile_pleine.gif" width="15" height="13"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td rowspan="4"><img src="images/spacer.gif" width="5" height="1"></td>
                      <td nowrap class="rate">JASON DANN 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink">  2004-07-09 15:53:25</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td width="100%" nowrap class="newsteaser"><table width="1%" border="0" cellspacing="2" cellpadding="0">
                        <tr>
                      <td><img src="images/p_etoile_pleine.gif" width="15" height="13"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">IT IS VERY COOL	<br>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="6" class="text"><img src="images/spacer.gif" width="1" height="10"></td>
	  ...
	  <tr>
        <td><blockquote>
        <div align="center" class="copyright">© MMMIII New Line Productions, Inc. All Rights Reserved.</div>
        <br>
&nbsp;</blockquote></td>
    </tr>
	  <tr>
...
hsi += '&p=Game_Page-The+Lord+Of+The+Rings%3A+TheReturn+of+the+King';
...
<noscript>
analyse mesure frequentation internet par <img width="39" height="25" border=0 src="http://logv25.xiti.com/hit.xiti?s=159070&p=Game_Page-The+Lord+Of+The+Rings%3A+TheReturn+of+the+King&" title="Mesurez votre audience">
</noscript><!--//--></a></div></td>
  </tr>
</table>
