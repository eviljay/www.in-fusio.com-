...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=55#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=55", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Winter Sports</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1"><STRONG>Engage in fierce competition and try to excel in 6 thrilling winter events!</STRONG> <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_55/image_02_jeu.jpg" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=55','','width=250,height=250')"><img src="admin/Jeu/jeu_55/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=55','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">Winter Sports is a game in which there are 6 winter events: Snowboard, Combined downhill, Biathlon, Downhill skiing, Cross-country skiing and Jump skiing. You can choose your level of difficulty, and try to achieve the best score. Stay cool!</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>A wide choice of events
<LI class='gamefeatures'>Multi-player challenges
<LI class='gamefeatures'>An evocative graphic environment
<LI class='gamefeatures'>Good, gripping game play</LI></UL> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=55','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_55/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_55/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_55/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>What is the Training Mode&nbsp;?<BR></FONT>Play for as long as you like in order to become familiar with the game. In this mode, you will only be able to achieve low scores.</P>
<P class='gametips'><FONT class=jtitre>What is the difference between the National Cup and the World Cup?<BR></FONT>To attain the National Cup, you must complete all training events during one session and to attain the World Cup, you must qualify for all National Cup events during one session.</P></div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td nowrap class="rate">raj 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink"> (India) 2004-10-20 14:47:59</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">exellent	<br>
                      </td>
                    </tr>
                    <tr>
...
<noscript>
analyse mesure frequentation internet par <img width="39" height="25" border=0 src="http://logv25.xiti.com/hit.xiti?s=159070&p=Game_Page-Winter+Sports&" title="Mesurez votre audience">
</noscript><!--//--></a></div></td>
  </tr>
</table>
