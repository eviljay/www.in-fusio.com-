...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=109#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=109", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">SabreWulf® Mobile</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1">Sabrewulf chases ensue in this huge adventure combining exploration, monster collection and classic platforming action <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_109/image_02_jeu.jpg" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=109','','width=250,height=250')"><img src="admin/Jeu/jeu_109/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=109','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">Based on the GBA game by the mythic studio RARE, this platform/adventure game&nbsp; will let you play Sabreman the adventurer. Armed only with an affinity for the creatures that you find along the way, you will have to hunt Sabrewulf to a final showdown</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>A well-known licence (Game Boy Advanced version recently released and coming with an eminent success 
<LI class='gamefeatures'>Colored and funny graphical atmosphere, closely sticking to the GBA version (15 levels, 8 kinds of ennemies,…) 
<LI class='gamefeatures'>Mixed platform and adventure game play for better and deeper gaming experience</LI></UL> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=109','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
								                 </p>
              </blockquote></td>
            <td width="5%">&nbsp;</td>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_109/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_109/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_109/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>What are the magic animals needed for?</FONT></P>
<P class='gametips'>The levels simply cannot be finished without the clever use of animals. They will help you blowing obstacles out, reaching inaccessible places and escaping unbeatable ennemies.</P>
<P class='gametips'><FONT class=jtitre>Where are the amulet pieces?</FONT></P>
<P class='gametips'>They are hidden inside the game…But if you complete a level without having found the amulet piece hidden in it, a message will then be displayed to warn you up. </P>
<P class='gametips'><FONT class=jtitre>How can I get more points?</FONT></P>
<P class='gametips'>You can re-play all the levels that you`ve already completed, if you have the feeling that you`ve missed some items or gold coins. This will bring you more points.</P></div>
