...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=8#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=8", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Celebrity Chic</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1"><STRONG>Girls, finally here’s your chance to become the celebrity you’ve always dreamed of being!</STRONG> <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_8/" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=8','','width=250,height=250')"><img src="admin/Jeu/jeu_8/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=8','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">Play the role of 2 different celebrity personalities in a <STRONG>2-episode game</STRONG>, making decisions that help or hinder your career as a musician or a fashion agent. On your rise to stardom, try to spot the difference between real opportunity and the ‘road to disaster’.</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>Girls`game
<LI class='gamefeatures'>Dynamic Scenes
<LI class='gamefeatures'>Low Entry Game Play
<LI class='gamefeatures'>No ‘Required’ SMS Interactions</LI></UL> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=8','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_8/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_8/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_8/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>What are the Smileys?</FONT></P>
<P class='gametips'>The Smileys in the game are there to represent your mood when you answer. You will react differently depending on your situation in the game, so you can be upset, crazy or happy about a question.</P>
<P class='gametips'><FONT class=jtitre>How do I download the next episode?</FONT></P>
<P class='gametips'>There are 2 ways to download the next episode. If you end the game, you’ll automatically be given the option of downloading the next story. Alternatively, you can choose the “Episode #” category in the main menu.</P>
<P class='gametips'><FONT class=jtitre>How do I win?</FONT></P>
<P class='gametips'>There is no winning or losing in this game, only the opportunity to get to know yourself better and experience a fun and original game!</P>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td nowrap class="rate">tyrell 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink">  2004-10-05 03:52:24</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">i really like this game cuz its a nice game and its fun
	<br>
                      </td>
                    </tr>
                    <tr>
...
hsi += '&p=Game_Page-Celebrity+Chic';
...
<noscript>
analyse mesure frequentation internet par <img width="39" height="25" border=0 src="http://logv25.xiti.com/hit.xiti?s=159070&p=Game_Page-Celebrity+Chic&" title="Mesurez votre audience">
</noscript><!--//--></a></div></td>
  </tr>
</table>
