...
<span id="goldorak" style="position:absolute; left:541px; top:1243px; width:11px; height:25px; z-index:5"><img src="../vehicules/goldorak.gif" width="150" height="136"></span><table width="686" border="0" cellspacing="0" cellpadding="0">
<tr><td width="76" valign="top"><img src="../technologie/images_tech/fusio_001.jpg" width="76" height="32"></td>
    <td width="118" valign="top">
        ...
        <tr><td height="70">
                <table width="119" border="0" cellspacing="0" cellpadding="0">
                <tr><td width="45"><img src="../technologie/images_tech/fusio_003.jpg" width="35" height="76"></td>
                    <td width="74" valign="top">
                        <table width="55" border="0" cellspacing="0" cellpadding="0">
                        <tr valign="top" align="right"><td><img src="illus/illus.jpg" width="83" height="67"></td></tr>
                        <tr><td><table width="77" border="0" cellspacing="0" cellpadding="0">
                                <tr><td width="10" height="2"><img src="../technologie/images_tech/004.jpg" width="29" height="9"></td>
                                    <td width="67" height="2"><img src="illus/005.jpg" width="54" height="9"></td></tr>
                                </table></td></tr>
                        </table></td></tr>
                </table></td></tr>
        </table></td>
    <td width="492" valign="top" background="illus/fusio_006.jpg">
        ...
        <tr><td width="10" background="illus/fond_fonce.jpg" valign="top" align="left"><img src="illus/fond_fonce.jpg" width="12" height="56"></td>
            <td width="471" background="illus/fond_fonce.jpg" valign="top">
                ...
                <tr><td width="190" class="titre" align="left" valign="bottom">IN-FUSIO'S SPIRIT</td>
                    <td width="274" class="text-titre" valign="bottom" align="left">Share your values first !</td></tr>
                </table></td>
        ...
        <tr><td width="10" align="left" valign="top" background="illus/fusio_007.jpg">&nbsp;</td>
            <td width="471" background="illus/fusio_007.jpg">
                ...
                <tr><td width="243" background="illus/fusio_007.jpg">&nbsp;</td>
                    <td width="77" valign="top" align="right" background="illus/fusio_006.jpg"><a href="#" onClick="MM_openBrWindow('../glossary.php','glossary','scrollbars=yes,resizable=yes,width=500,height=400')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','illus/bout_glossary-over.jpg',1)"><img src="illus/bout_glossary.jpg" width="82" height="17" border="0" name="Image1"></a></td>
                    <td width="54" align="left" valign="top" background="illus/fusio_006.jpg"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','illus/bout_exen-over.jpg',1)"><img src="illus/bout_exen.jpg" width="54" height="17" border="0" name="Image2" onMouseDown="MM_openBrWindow('../exen/exen.html','exen','resizable=yes,width=720,height=540')"></a></td>
                    <td width="81" background="illus/fusio_007.jpg">&nbsp;</td></tr>
                </table></td>
...
<tr><td width="77" valign="top" height="5"><img src="../technologie/images_tech/fusio_001.jpg" width="76" height="15"></td>
    ...
    <td width="545" background="illus/motif.jpg" valign="middle" height="5" nowrap>
        ...
        <tr><td width="49" height="15">&nbsp;</td>
            <td width="470" class="titre2" valign="middle" align="left">fun, respect, confidence and innovation</td></tr>
        </table></td></tr>
<tr><td width="77">&nbsp;</td>
    <td width="64">&nbsp;</td>
    <td width="545" background="illus/fusio_006.jpg">
        ...
        <tr><td width="68">&nbsp;</td>
            <td width="436" class="texte">The In-Fusio team is currently over 90-strong, covering a dozen nationalities, who have all joined to carry out the mad task of making this young Bordeaux-based start-up the world leader in Connected Mobile Games. The company's values are Fun, Respect, Confidence and Innovation. Combined with a strong team spirit, a large dose of company-wide ambition and clear individual missions they guarantee that however hard the work, we all have a good time.<p>&nbsp;</p></td></tr>
        </table></td></tr>
</table>
</BODY></HTML>
