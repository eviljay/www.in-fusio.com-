<HTML>
<HEAD>
<TITLE>Age of Empires®II:Mobile</TITLE>
...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=114#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=114", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Age of Empires®II:Mobile</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1"><P>The greatest strategy game ever is now available on mobile : Age of Empires®II:Mobile. A new AGE is upon you!</P> <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_114/image_02_jeu.jpg" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=114','','width=250,height=250')"><img src="admin/Jeu/jeu_114/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=114','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">Age of Empires®II:Mobile : a new “AGE” is upon you! Play the mobile version of the greatest strategy game ever.&nbsp; Lead 2 different civilizations to victory through 4 time periods, with 13 types of buildings and 7 types of units to control.</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>The most famous strategy game ever, and a legend in the history of videogames. Still ranked inside the TOP 3 best sellers on PC 
<LI class='gamefeatures'>A unique gaming experience for mobile : containing specially designed scenarios and Artificial Intelligence, 13 types of buildings, 7 types of units, 4 ages, 2 civilisations, etc...</LI></UL> <br>
			   Available on JAVA DOJA BREW ExEn EGE SYMBIAN WINDOWS MOBILE <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=114','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
								                 </p>
              </blockquote></td>
            <td width="5%">&nbsp;</td>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_114/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_114/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_114/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>What are the most efficient units against buildings?<BR></FONT>Battering Ram &amp; Mangonel</P>
<P class='gametips'><FONT class=jtitre>How can I reach the next age of my civilisation?<BR></FONT>Create a certain number of buildings</P>
<P class='gametips'><FONT class=jtitre>How can I speed up the resource harvest?<BR></FONT>Build a mine camp (or mill camp) near the gold/stone resources (or tree resources)</P>
<P class='gametips'><FONT class=jtitre>How can I have stronger units?<BR></FONT>Search for upgrades at the blacksmith’s</P>
<P class='gametips'><FONT class=jtitre>How can I have stronger buildings?<BR></FONT>Search for upgrades in the university</P></div>
...
<tr>
	  ...
	  <tr>
        <td><blockquote>
        <div align="center" class="copyright">© 2005 Microsoft. All rights reserved. Microsoft, the Microsoft Game Studios logo, Age of Empires® and Ensemble Studios are either trademarks or registered trademarks of Microsoft Corporation in the United States and/or other countries.</div>
        <br>
&nbsp;</blockquote></td>
    </tr>
	  <tr>
