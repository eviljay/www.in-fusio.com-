...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=92#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=92", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Tomb Raider</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1">Go exploring, avoiding the pitfalls and traps in your search for the legendary treasures of Egypt <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_92/image_02_jeu.jpg" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=92','','width=250,height=250')"><img src="admin/Jeu/jeu_92/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=92','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">Run, jump, climb, shoot and plan your way past&nbsp; the traps, obstacles and enemies in your search for the legendary treasures of Egypt.</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>Long and deeply intriguing quest 
<LI class='gamefeatures'>Many riddles to solve 
<LI class='gamefeatures'>Dexterity and strengh required to pass through the numerous tunnels</LI></UL> <br>
			   <P class='gamefeatures'>Available on ExEn only. Select your country, operator and phone on the right to check availability.</P> <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=92','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_92/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_92/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_92/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td nowrap class="rate">Vasek 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink"> (USA) 2004-11-19 08:35:56</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">Supppppper Games	<br>
                      </td>
                    </tr>
                    <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td rowspan="4"><img src="images/spacer.gif" width="5" height="1"></td>
                      <td nowrap class="rate">chris browning 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink"> (Australia) 2004-11-17 21:16:47</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td width="100%" nowrap class="newsteaser"><table width="1%" border="0" cellspacing="2" cellpadding="0">
                        <tr>
                      <td><img src="images/p_etoile_pleine.gif" width="15" height="13"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">this game is the BEST GAME yet
	<br>
                      </td>
                    </tr>
                    <tr>
...
<noscript>
analyse mesure frequentation internet par <img width="39" height="25" border=0 src="http://logv25.xiti.com/hit.xiti?s=159070&p=Game_Page-Tomb+Raider&" title="Mesurez votre audience">
</noscript><!--//--></a></div></td>
  </tr>
</table>
