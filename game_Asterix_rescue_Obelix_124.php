<HTML>
<HEAD>
<TITLE>Asterix rescue Obelix</TITLE>
...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=124#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=124", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Asterix rescue Obelix</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1">Obelix drank a whole cauldron of magic potion, turned into stone and was captured.&nbsp; Help Asterix rescue him! <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_124/image_02_jeu.jpg" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=124','','width=250,height=250')"><img src="admin/Jeu/jeu_124/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=124','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">Obelix disobeys Getafix\'s orders : he drinks a cauldron of magic potion and turns into stone.&nbsp; The Romans seize the chance and capture him.&nbsp; Help Asterix rescue his companion through the 12 levels of this action platform game.</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>fights with the soldiers</LI>
<LI class='gamefeatures'>non-linear progression through the levels</LI></UL>
<P class='gamefeatures'>&nbsp;</P> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=124','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
								                 </p>
              </blockquote></td>
            <td width="5%">&nbsp;</td>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_124/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_124/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_124/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><STRONG>How many lives do I have to start the game? <BR></STRONG>The player has 3 lives to start with. If you loose your 3 lives you die. You can win additional lives with the heart. The heart restores 1 life point to the player (added to the life points bar)</P>
<P class='gametips'><STRONG>How many levels are there in the game?</STRONG> <BR>There are 3 worlds containing 4 levels each. The Woods and the roman camp are available when you download the game. The dolmens can be unlocked by&nbsp; interaction or if you win all bonuses of the game.&nbsp; </P>
<P class='gametips'><STRONG>How long does the effect of magic potion last?</STRONG> <BR>The flask of magic potion provides the strength required to make the player invincible for 3 seconds.&nbsp; Its&nbsp; effect does not restore any life points which the player may have lost.</P>
<P class='gametips'><STRONG>How can I get the golden sickle? <BR></STRONG>The golden sickle is not available in the levels. It is unlocked in the score table when the player has found all of bonuses of a level. </P></div>
...
<tr>
	  ...
	  <tr>
        <td><blockquote>
        <div align="center" class="copyright">© 2005 LES EDITIONS ALBERT RENE / GOSCINNY - UDERZO</div>
        <br>
&nbsp;</blockquote></td>
    </tr>
	  <tr>
