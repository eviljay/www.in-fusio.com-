...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=89#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=89", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Crazy Cobra 2</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1">Beware!&nbsp; Do not bite yourself or hit a deadly wall whilst clearing the levels! Reach the Ultimate Crazy Speed! <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_89/image_02_jeu.jpg" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=89','','width=250,height=250')"><img src="admin/Jeu/jeu_89/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=89','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">Crazy Cobra2 is a remake of the classic Snake games, improved with&nbsp; new cobras, new surprise pills and exciting worlds on your mobile! Clear the levels by eating all the pills before the time runs out! Reach the Ultimate Crazy Speed!</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>3 difficulty speed settings: Easy, Normal and Crazy speed
<LI class='gamefeatures'>Simple and fun game-play
<LI class='gamefeatures'>New pills to eat, new obstacles and different cobras
<LI class='gamefeatures'>New world of Magma, Sand and the Moon</LI></UL>
<P class='gamefeatures'>&nbsp;</P> <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_89/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_89/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_89/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>What does -The Cobra bites himself- mean?<BR></FONT>If the head of the cobra crosses any part of the longer and longer body, your cobra loses a life</P>
<P class='gametips'><FONT class=jtitre>When is the Crazy Mode accessible?<BR></FONT>The Crazy Mode gets unlocked when you finish the Normal Mode</P>
<P class='gametips'><FONT class=jtitre>How long does the effect of a Bonus pill last?<BR></FONT>Once you get a bonus, you can see a small red rectangle on top of your screen getting darker and darker. When your bonus time is over, the rectangle is black.</P></div>
