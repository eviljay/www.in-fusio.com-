...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=85#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=85", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Ghost Hunter</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1">Fight the flying ghosts with your harpoon ! Seek and destroy them&nbsp;in all&nbsp;6 rooms of the manor. <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_85/image_02_jeu.jpg" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=85','','width=250,height=250')"><img src="admin/Jeu/jeu_85/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=85','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">You are a ghost hunter and your job is to get rid of all the ghosts in the haunted manor. Shoot them with your harpoon until they completely disappear. Try to catch the bonuses to help you in your task.&nbsp;&nbsp;</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'><FONT face=Arial>Wonderfully simple, yet incredibly challenging game-play </FONT><FONT face=Arial>
<LI class='gamefeatures'>Funny and scary atmosphere
<LI class='gamefeatures'>30 levels in a haunted manor</FONT></LI></UL>
<P class='gamefeatures'>&nbsp;</P> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=85','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_85/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_85/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_85/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>How do you kill the ghosts?&nbsp;<BR></FONT><FONT class=jnormal>You have to&nbsp;shoot the ghosts several times&nbsp;in order to kill them completely as&nbsp;they split into smaller ghosts each time they are hit.</FONT></P>
<P class='gametips'><FONT class=jtitre>How do you get bonuses?<BR></FONT>The ghosts sometimes drop&nbsp;bonuses when they have been shot.&nbsp;All you have to do is move towards them to grab the bonuses.<BR></P></div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td nowrap class="rate">lex 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink"> (Poland) 2004-10-29 09:40:58</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td rowspan="4"><img src="images/spacer.gif" width="5" height="1"></td>
                      <td nowrap class="rate">coulibaly sounan 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink"> (France) 2004-10-27 12:55:16</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td width="100%" nowrap class="newsteaser"><table width="1%" border="0" cellspacing="2" cellpadding="0">
                        <tr>
                      <td><img src="images/p_etoile_pleine.gif" width="15" height="13"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">it is nice	<br>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="6" class="text"><img src="images/spacer.gif" width="1" height="10"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink"> (China) 2004-10-12 03:17:35</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td width="100%" nowrap class="newsteaser"><table width="1%" border="0" cellspacing="2" cellpadding="0">
                        <tr>
                      <td><img src="images/p_etoile_pleine.gif" width="15" height="13"></td>
...
<noscript>
analyse mesure frequentation internet par <img width="39" height="25" border=0 src="http://logv25.xiti.com/hit.xiti?s=159070&p=Game_Page-Ghost+Hunter&" title="Mesurez votre audience">
</noscript><!--//--></a></div></td>
  </tr>
</table>
