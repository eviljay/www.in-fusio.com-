...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=118#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=118", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">SVEN 004</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1"><STRONG>Sven 004: the horny ram with the license to shag.</STRONG> <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_118/image_02_jeu.gif" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=118','','width=250,height=250')"><img src="admin/Jeu/jeu_118/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=118','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">Sven Bømwøllen is back. This time, he takes his cue from secret agent and ladies’ man James Bond – but with a small, yet significant difference. Seduction is a fringe benefit for 007 – but for Sven, shagging till he drops is central to his assignment.</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>Handy port of one of Germany´s most successful casual games ever. 
<LI class='gamefeatures'>Fun and easy to pick up arcade game. 
<LI class='gamefeatures'>Hilarious fun, suggestive but not obscene.</LI></UL> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=118','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
								                 </p>
              </blockquote></td>
            <td width="5%">&nbsp;</td>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_118/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_118/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_118/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>How does the game save?<BR></FONT>The game automatically saves the players progress after a finished mission so he can continue with the next mission at a later time. Please keep in mind that a real high score can only be achieved when the player plays the game through in one piece. If the game is over, the score will be reset.</P>
<P class='gametips'><FONT class=jtitre>Who are Sven’s enemies ?</FONT><BR>Be sure to watch out for the shepherd and his dog Wøtan. Sven has been on their list for some time now, and if they catch him, he\'s in for a serious beating. Reason enough to always watch your back – no matter how hot the action gets. Maybe the biggest enemy is the clock though.</P>
<P class='gametips'><FONT class=jtitre>There are several items in the game, what do they do ?</FONT><BR>Rocket:&nbsp; Sven runs and shags faster for a limited amount of time. / Horn: it makes some noise. The sheep might get scared and start running. Unfortunately some of them are quite dumb and might fall into the water. / Present: Gives a small time bonus. / Keys: Some locked gates require a key that can be found somewhere in the level.</P>
<P class='gametips'><FONT class=jtitre>I need more lifes<BR></FONT>Extra lives are awarded if you reach a certain score. On top of that you get a mercy bonus (an additional life) if you quickly lose 2 lives in a row.</P></div>
