...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=107#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=107", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Fruit Factory 2</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1">Help Nina travelling across the 48 levels of YumYumLand : gather yummies and escape her nightmare enemies! <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_107/image_02_jeu.gif" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=107','','width=250,height=250')"><img src="admin/Jeu/jeu_107/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=107','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">Nina explores the 48 levels of YumYumLand and its Frosted Forest. She wanders in cloudy dreams or nightmare mazes eating new magic yummies.&nbsp; Help Nina to reach the Heaven Shore, escaping the traps of her night enemies! Be careful! They are everywhere!</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>accessible to beginners</LI>
<LI class='gamefeatures'>nice interface</LI>
<LI class='gamefeatures'>sweet graphics</LI></UL> <br>
			   On ExEn handsets only <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=107','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
								                 </p>
              </blockquote></td>
            <td width="5%">&nbsp;</td>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_107/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_107/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_107/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>Who is Nina?</FONT> </P>
<P class='gametips'>Nina is a sweet girl but when it comes to getting yummies, nothing can stop her : after being kidnapped by a fridge in Fruit Factory, she now explores YumYumLand every night in her dreams. </P>
<P class='gametips'><FONT class=jtitre>Can Nina die?</FONT> </P>
<P class='gametips'>No. You can play as long as you want, Nina will never die. If you fail a level, she will swim, or slide on ice, she will puff off in a cloud, and you can play again.</P>
<P class='gametips'><FONT class=jtitre>What type of enemies does Nina has?</FONT> </P>
<P class='gametips'>There 3 types of monsters : - The Slow Monsters (The Snowman, the Knight, the Storm) , the Fast Monsters (the Duck, the Mouse, the Star) and the Chaser Monsters (the Dog, the Prince, the Moon). </P>
<P class='gametips'><FONT class=jtitre>How do I actionate the bubble?</FONT> </P>
<P class='gametips'>If you really don\'t succeed a level, you can use a bubble to protect yourself. Be careful, you can use it only once per level. Bubbles are available from level 8 through the shop (SC2). To use it, press # then 5. It will protect you from all ennemies around you. </P></div>
