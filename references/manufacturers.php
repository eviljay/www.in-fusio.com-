              ...
              <tr> 
                ...
                <td width="471" background="illus/fond_fonce.jpg" valign="top"> 
                  <table width="464" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td width="190" class="titre" align="center" valign="bottom">MANUFACTURERS</td>
                      <td width="274" class="chapo" valign="bottom" align="left">We set up partnerships with manufacturers to ensure that our games are perfectly adapted to all handsets</td>
                    </tr>
                  </table>
                </td>
          ...
          <td width="545" background="illus/motif.jpg" valign="middle" height="5" nowrap> 
            <table width="545" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="503" class="titre2" valign="middle" align="left">The ExEn handsets arrive on the market</td>
              </tr>
            </table>
          </td>
        </tr>
            ...
            <table width="530" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="436" class="texte"> 
                  ...
                  <tr><td><span class="text-titre">Philips</td></tr>
                  <tr><td class="texte"><img src="../getimage.php?get=image&b=menureferences&r=4" align="right">In-Fusio starts the launch of downloadable games (ExEn®) on mobiles with Philips Consumer Communications. "Mobile services are the logical next step for us based on our existing competences in both the consumer mobile market and mobile technology," declares Tony Burt, Business Director Mobile Internet. \"We are partnering with the industry innovator In-Fusio, and we1re looking forward to offering this new service to our customers, and particularly bringing the excitement of on-line games to the mobile phone." </td></tr>
                  </table>
<BR>
                  <table width="450" border="0" cellspacing="3" cellpadding="0">
                  <tr><td><span class="text-titre">Mitsubishi</td></tr>
                  <tr><td class="texte"><img src="../getimage.php?get=image&b=menureferences&r=5" align="right">Conscious of the importance of connected games on cellular phones, Trium has integrated the interactive embedded games and is about to launch ExEn® on its Luna and Laser handsets. Kouji Kodera, Marketing Director from Mitsubishi Electronic Telecom Europe, declares : "The market opportunity for mobile entertainment is tremendous. And Trium believes that within the mobile entertainment field, games will play a significant role".</td></tr>
                  </table>
<BR>
                  <table width="450" border="0" cellspacing="3" cellpadding="0">
                  <tr><td><span class="text-titre">Sagem</td></tr>
                  <tr><td class="texte"><img src="../getimage.php?get=image&b=menureferences&r=8" align="right">As the result of a fruitful partnership with In-Fusio, Sagem has been integrating the ExEn® download gaming engine into its 3000 mobile phones series since October 2001. The first French manufacturer to use In-Fusio's technology, Sagem believes that, by allowing customers to play downloadable games off-line, mobile phones become constantly evolving entertainment devices.</td></tr>
                  </table>
<BR>
                  <p>&nbsp; </p>
                  <p>&nbsp;</p>
