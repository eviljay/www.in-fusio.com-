              ...
              <tr> 
                ...
                <td width="471" background="illus/fond_fonce.jpg" valign="top"> 
                  <table width="464" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td width="190" class="titre" align="center" valign="bottom">PLAYERS</td>
                      <td width="274" class="chapo" valign="bottom" align="left">"There can be no doubt that users of cellular phones are avid gamers !" - Giles Corbett, Managing Director In-Fusio</span></td>
                    </tr>
                  </table>
                </td>
          ...
          <td width="545" background="illus/motif.jpg" valign="middle" height="5" nowrap> 
            <table width="545" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="535" class="titre2" valign="middle" align="left">Connected Mobile Gaming at the Crossroads Between Games, Cellular Phones and the Internet</td>
              </tr>
            </table>
          </td>
        </tr>
        <tr>
          ...
          <td width="545" background="illus/fusio_006.jpg" valign="top"> 
            <table width="530" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="68">&nbsp;</td>
                <td width="436" class="texte">The first games were launched just over a year ago, and since then, In-Fusio's efforts have paid off with over 10 million sessions played, all technologies and operators taken into account. An important percentage of these sessions comes from embedded SMS games and WAP games . The majority of gamers are European.<p>&nbsp;</p></td>
              </tr>
            </table>
          </td>
        </tr>
