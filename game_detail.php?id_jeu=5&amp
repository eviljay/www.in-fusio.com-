...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=5#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=5", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Bombjack™</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1"><STRONG>Disarm the bombs and kill your enemies – before it’s too late. TICK…TICK…TICK…</STRONG> <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_5/image_02_jeu.jpg" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=5','','width=250,height=250')"><img src="admin/Jeu/jeu_5/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=5','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">Jack’s mission is to dispose of the bombs, and avoid or kill his increasingly dangerous enemies. As Jack, you will run, jump, fly and hover through 64 levels in 5 different worlds.&nbsp; But watch out! You only have three lives, and the bombs are ticking…!</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>Adapted from the Original BombJack arcade game
<LI class='gamefeatures'>Totally addictive game play
<LI class='gamefeatures'>Start level choice
<LI class='gamefeatures'>Colourful and exotic graphics</LI></UL> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=5','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_5/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_5/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_5/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>How do I reach high platforms?</FONT> <BR><FONT class=jnormal>Some platforms are too high for normal jumps, so&nbsp;you will have to do a special High Jump. This is achieved by pushing buttons 2 and 5 successively. </FONT></P>
<P class='gametips'><FONT class=jtitre>How can I obtain a higher score?<BR></FONT>You&nbsp;will achieve a higher score if&nbsp;you collect the lit bombs in sequence.</P></div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td nowrap class="rate">HuLiGaN 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink">  2004-07-09 14:08:11</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">The best nice game	<br>
                      </td>
                    </tr>
                    <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td rowspan="4"><img src="images/spacer.gif" width="5" height="1"></td>
                      <td nowrap class="rate">Rik 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink">  2004-05-16 23:39:20</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td width="100%" nowrap class="newsteaser"><table width="1%" border="0" cellspacing="2" cellpadding="0">
                        <tr>
                      <td><img src="images/p_etoile_pleine.gif" width="15" height="13"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">Bombjack rules !	<br>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="6" class="text"><img src="images/spacer.gif" width="1" height="10"></td>
	  ...
	  <tr>
        <td><blockquote>
        <div align="center" class="copyright"><P class='gametips'><FONT class=jnormal>BombJack ™ & ® 1984 - 2003, Tecmo Ltd. Japan. (P) 1985 - 2003, Elite Systems Ltd. England. ExEn version developed for and distributed by In-fusio S.A. France.</FONT></P></div>
        <br>
&nbsp;</blockquote></td>
    </tr>
	  <tr>
...
<noscript>
analyse mesure frequentation internet par <img width="39" height="25" border=0 src="http://logv25.xiti.com/hit.xiti?s=159070&p=Game_Page-Bombjack%99&" title="Mesurez votre audience">
</noscript><!--//--></a></div></td>
  </tr>
</table>
