...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=121#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=121", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">I, Robot</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1">Based on the hit-action-movie `I, Robot`. <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_121/image_02_jeu.gif" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=121','','width=250,height=250')"><img src="admin/Jeu/jeu_121/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=121','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">`I, Robot`, based on the futuristic thriller from Twentieth Century Fox, brings the future to the palm of your hand. In this fast-moving platform game, you`ll experience a unique vision of a world where intelligent robots live among us in perfect harmony.</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>3 different characters to control. 
<LI class='gamefeatures'>Follow exactly the script of the movie.</LI></UL> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=121','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
								                 </p>
              </blockquote></td>
            <td width="5%">&nbsp;</td>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_121/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_121/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_121/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>How to win the game?</FONT><BR>When the player completes stage 2 of level 3, they have won the main game. After the “Mission accomplished” text has been displayed, the player is shown a screen similar in style to the Classified screen off the Main Menu. The player will then be returned to the Main Menu. From now on, when the player chooses the Classified option on the Main Menu, the correct password is filled in automatically, and they can access the mini games.</P>
<P class='gametips'><FONT class=jtitre>Losing the game</FONT><BR>The player can lose the game 2 ways:<BR>1. If time runs out the game will be over.<BR>2. If the player’s health meter drops to zero they will have failed and the game will be over. </P>
<P class='gametips'><FONT class=jtitre>What are the mini-games?<BR></FONT>Last robot standing / Jumping Puzzle / Escape / Collector</P></div>
...
<tr>
	  ...
	  <tr>
        <td><blockquote>
        <div align="center" class="copyright">© 2004, Fox Inc. All rights reserved.</div>
        <br>
&nbsp;</blockquote></td>
    </tr>
	  <tr>
