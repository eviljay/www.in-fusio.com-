<HTML>
<HEAD>
<TITLE>Banjo-Kazooie® Grunty`s Revenge: Mobile</TITLE>
...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=102#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=102", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Banjo-Kazooie® Grunty`s Revenge: Mobile</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1">Banjo-Kazooie are back on mobile! Challenge Gruntilda witch and rescue your long lost and feathery pal Kazooie <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_102/image_02_jeu.jpg" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=102','','width=250,height=250')"><img src="admin/Jeu/jeu_102/image_04_jeu.jpg" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=102','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">Banjo-Kazooie in your hand; whenever you want, wherever you are! Taking control of Banjo in this adventure game, you will have to traverse magical and coloured worlds in search of your long lost and feathery pal Kazooie</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>Endearing and already very popular characters (Banjo the bear and Kazooie the bird) 
<LI class='gamefeatures'>Funny and magical atmosphere, sticking to the original game 
<LI class='gamefeatures'>True and deep action/adventure game</LI></UL> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=102','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
								                 </p>
              </blockquote></td>
            <td width="5%">&nbsp;</td>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_102/image_05_jeu.jpg" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_102/image_06_jeu.jpg" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_102/image_07_jeu.jpg" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>What should I do to free Kazooie?</FONT></P>
<P class='gametips'>Along you way, you will have to collect Jiggys (magic puzzle pieces) that you will use to&nbsp; break the curse that keeps Kazooie emprisonned. </P>
<P class='gametips'><FONT class=jtitre>How can I learn special abilities (swiming, climbing, fighting,etc…)?</FONT></P>
<P class='gametips'>The characters you will meet during your quest will ask you to help them or to collect special items. Doing that, they will teach you special abilitites that you will need to complete your mission</P>
<P class='gametips'><FONT class=jtitre>What should I do if I miss only few magic notes or other item to complete my mission?</FONT></P>
<P class='gametips'>Explore the maps in details or talk to the Mole. He can help you find your way. </P></div>
