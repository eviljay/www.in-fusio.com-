<HTML>
<HEAD>
<TITLE>Flynn`s Adventures</TITLE>
...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=42#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=42", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Flynn`s Adventures</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1"><P>Be Flynn the Nightmare Buster !!</P> <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_42/image_02_jeu.jpg" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=42','','width=250,height=250')"><img src="admin/Jeu/jeu_42/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=42','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy"><P class='gamecopy'>As Flynn the elf, embark on a mission to protect the children from the monsters that haunt them in their nightmares. Take on an array of enemies, including gargoyles, fireballs and slew of level bosses using various attack moves and Flynn’s trusty deck of trick cards.</P></div>
              <strong><br>
              Features:</strong><br>
              <FONT class='gamefeatures'>
<UL><FONT color=#333333>
<UL type=disc>
<LI class='gamefeatures'>10 dynamic and macabre levels&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
<LI class='gamefeatures'>Beautiful graphics, inspired by a title for the Super Nintendo 
<LI class='gamefeatures'>3 different play modes: easy,&nbsp;normal and an unlockable mode for an even bigger challenge!</LI></UL>
<P class='gamefeatures'></FONT>&nbsp;</P>
<UL type=disc></UL></UL>
<P class='gamefeatures'></FONT></P> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=42','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
								                 </p>
              </blockquote></td>
            <td width="5%">&nbsp;</td>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_42/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_42/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_42/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre><BR>How to play «&nbsp;Hard Mode&nbsp;» ?</FONT><FONT class=jnormal><BR></FONT><FONT class=jnormal>To play hard mode you have to finish the&nbsp;normal mode. Hard mode is reserved for very good players. Good luck !</FONT></P>
<P class='gametips'><FONT class=jtitre>Is it possible to have more than 2 protection points&nbsp;?</FONT><FONT class=jnormal><BR></FONT><FONT class=jnormal>No. When you have two protection points and you collect a third one, you become invincible for few seconds. </FONT></P>
<P class='gametips'><FONT class=jtitre>Which are the invulnerable enemies&nbsp;?</FONT><FONT class=jnormal><BR></FONT><FONT class=jnormal>You must steer clear of 4 types of enemy who are invincible: Iron Ball, Fire, Houx and Fire Ball.<BR></FONT></P></div>
...
<tr>
          <td valign="top"><table width="497" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td rowspan="8">&nbsp;</td>
                <td colspan="3"><p><span class="rate">Rating</span><span class="newstitel"> </span><span class="gamefeatures">9                      Reviews </span></p>
                </td>
              </tr>
              <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td nowrap class="rate">Jordan Sukay 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink">  2004-09-02 19:40:07</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">great game I would to give it more stars if there were more	<br>
                      </td>
                    </tr>
                    <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td rowspan="4"><img src="images/spacer.gif" width="5" height="1"></td>
                      <td nowrap class="rate">evano 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink">  2004-08-02 16:19:27</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td width="100%" nowrap class="newsteaser"><table width="1%" border="0" cellspacing="2" cellpadding="0">
                        <tr>
                      <td><img src="images/p_etoile_pleine.gif" width="15" height="13"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">good but needed more than ten levels or at least the option to download more of them	<br>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="6" class="text"><img src="images/spacer.gif" width="1" height="10"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td rowspan="4"><img src="images/spacer.gif" width="5" height="1"></td>
                      <td nowrap class="rate">sam 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink">  2004-07-29 18:26:01</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td width="100%" nowrap class="newsteaser"><table width="1%" border="0" cellspacing="2" cellpadding="0">
                        <tr>
                      <td><img src="images/p_etoile_pleine.gif" width="15" height="13"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">a brill and fun game to play	<br>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="6" class="text"><img src="images/spacer.gif" width="1" height="10"></td>
