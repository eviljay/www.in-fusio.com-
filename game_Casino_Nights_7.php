...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=7#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=7", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Casino Nights</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1"><STRONG>Recreate the excitement, buzz and energy of the casino! Best of luck!</STRONG> <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_7/image_02_jeu.jpg" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=7','','width=250,height=250')"><img src="admin/Jeu/jeu_7/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=7','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">Experience the thrills of the game! In the main room you can play black jack, jackpot or video poker. Once you become a VIP player, by winning 100 chips, you’ll be authorised to enter the private room where you can play super jackpot and roulette.</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>The first ever gambling game
<LI class='gamefeatures'>A rich and evocative universe
<LI class='gamefeatures'>A wide choice of casino games</LI></UL> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=7','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_7/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_7/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_7/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>What does “doubling” mean in Black Jack?<BR></FONT><FONT class=jnormal>If you are dealt a total of 9, 10 or 11 in your initial hand, you may double down. This doubles your bet, but you are only allowed to draw one further card.</FONT></P>
<P class='gametips'><FONT class=jtitre>What does “splitting” mean in Black Jack?<BR></FONT><FONT class=jnormal>This allows you to play 2 hands if you are dealt identical cards, each starting with one of the cards. Your bet is split between the two hands.</FONT></P></div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td nowrap class="rate">mounir 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink">  2004-06-23 16:53:10</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">it's a good game	<br>
                      </td>
                    </tr>
                    <tr>
...
<noscript>
analyse mesure frequentation internet par <img width="39" height="25" border=0 src="http://logv25.xiti.com/hit.xiti?s=159070&p=Game_Page-Casino+Nights&" title="Mesurez votre audience">
</noscript><!--//--></a></div></td>
  </tr>
</table>
