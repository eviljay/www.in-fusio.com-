...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=115#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=115", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Etch A Sketch</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1">The original drawing toy brought to your mobile. Sketch a picture, create a masterpiece, release the artist in you! <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_115/image_02_jeu.jpg" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=115','','width=250,height=250')"><img src="admin/Jeu/jeu_115/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=115','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">The original, favorite drawing toy brought to your wireless phone! Use the number pad or arrow keys to control the stylus as you sketch a picture, scribble a note, or create a masterpiece. Release the artist in you!</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>The sketching stylus can be controlled using either the numerical keypad or arrow keys 
<LI class='gamefeatures'>Up to three separate sketches can be stored in the handset’s memory 
<LI class='gamefeatures'>Pressing the erase button causes the phone to vibrate as the sketch disappears</LI></UL> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=115','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
								                 </p>
              </blockquote></td>
            <td width="5%">&nbsp;</td>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_115/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_115/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_115/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>Is this the same Etch A Sketch I used to play with as a kid?</FONT><FONT class=jtitre></FONT><BR>Well, yes and no. It’s a wireless version of drawing tablet you played with as a kid. Same idea, but on a wireless phone instead. Cool, huh?</P>
<P class='gametips'><FONT class=jtitre>So does that mean if I shake the phone my picture will disappear?</FONT>&nbsp; <BR>Fortunately, no. But if you want to erase your current picture, press the clear key (or back button) and then select Erase. The phone will take care of the shaking from there.</P>
<P class='gametips'><FONT class=jtitre>How do I save my current sketch? <BR></FONT>Press the clear key (or back button) and select Save. Then text in a name for your masterpiece and select OK.</P>
...
<tr>
	  ...
	  <tr>
        <td><blockquote>
        <div align="center" class="copyright">The Etch A Sketch® product name and the configuration of the Etch A Sketch product are registered trademarks owned by The Ohio Art Company.</div>
        <br>
&nbsp;</blockquote></td>
    </tr>
	  <tr>
