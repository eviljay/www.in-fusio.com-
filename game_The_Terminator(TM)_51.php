...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=51#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=51", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">The Terminator™</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1"><STRONG>The machines have taken over the world! <BR>Save the human race from the Cyborgs</STRONG> <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_51/image_02_jeu.jpg" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=51','','width=250,height=250')"><img src="admin/Jeu/jeu_51/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=51','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">During the violent war between Cyborgs and humans, you will act as a human rebel soldier, fighting desperately to free mankind from the domination of the machines. The Terminator will try its best to stop you. Don’t forget, the future of the human race depends on you!</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>A shoot ‘em up game
<LI class='gamefeatures'>Rich, powerful graphics
<LI class='gamefeatures'>A very simple and addictive game-play</LI></UL> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=51','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_51/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_51/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_51/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>What is the Armoury screen?<BR></FONT>Before each level, you’ll be able to choose some equipment. 4 different items are available: med kit (half-life gained); armour (will save you three times from enemy fire); bomb (to destroy all enemies at once using (*)); weapons (change your weapon for a more powerful one).</P>
<P class='gametips'><FONT class=jtitre>What kind of enemies will I face?<BR></FONT>In each screen, cyborgs and machines will appear from either left or right. To neutralize your enemies, you have to shoot them at least once. Here is a non-exhaustive list of enemies: T-800 human like, drone, laser tank, hunter killer...<BR></P></div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td nowrap class="rate">desi antoni 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink">  2004-09-29 13:00:37</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">good enough	<br>
                      </td>
                    </tr>
                    <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td rowspan="4"><img src="images/spacer.gif" width="5" height="1"></td>
                      <td nowrap class="rate">Thomas 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink">  2004-06-27 21:12:17</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td width="100%" nowrap class="newsteaser"><table width="1%" border="0" cellspacing="2" cellpadding="0">
                        <tr>
                      <td><img src="images/p_etoile_pleine.gif" width="15" height="13"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">A fun game but lacks good graphics
	<br>
                      </td>
                    </tr>
                    <tr>
	  ...
	  <tr>
        <td><blockquote>
        <div align="center" class="copyright"><FONT class=jnormal>©1984 StudioCanal Image S.A. f/k/a Canal+ D.A. all rights reserved.  Terminator is a trademark of StudioCanal Image S.A. f/k/a Canal+ D.A</FONT></div>
        <br>
&nbsp;</blockquote></td>
    </tr>
	  <tr>
...
hsi += '&p=Game_Page-The+Terminator%99';
...
<noscript>
analyse mesure frequentation internet par <img width="39" height="25" border=0 src="http://logv25.xiti.com/hit.xiti?s=159070&p=Game_Page-The+Terminator%99&" title="Mesurez votre audience">
</noscript><!--//--></a></div></td>
  </tr>
</table>
