...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=82#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=82", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Solitaire</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1"><P>In this Solitaire pack, find the three classic challenging games : <BR>Klondike Solitaire <BR>2 Cards Summit<BR>Sum 21</P> <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_82/image_02_jeu.gif" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=82','','width=250,height=250')"><img src="admin/Jeu/jeu_82/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=82','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy"><P class='gamecopy'>Had enough of&nbsp;being bored in waiting rooms? Awaiting a card game for your leisure time? Solitaire Gold is for you! Three games, three different goals in one. Enjoy an accomplished mobile card game with a fast, few clicks card-movement controls.</P></div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>Intuitive keypad controls
<LI class='gamefeatures'>
<DIV class='gamefeatures'>3 Games that respect a balanced win percentage</DIV>
<LI class='gamefeatures'>
<DIV class='gamefeatures'>Rewards within the game </DIV></LI></UL> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=82','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_82/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_82/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_82/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>Solitaire&nbsp; </FONT><BR>The object of Solitaire is to complet piles (called Foundations) of all four-suits (Hearts, Spades, Clubs, and Diamonds) starting with Aces and going through suit and rank sequence to Kings. </P>
<P class='gametips'><FONT class=jtitre>2 Cards Summit</FONT> <BR>The object of 2 Card Summit is to clear two “Summits” of playing cards from the screen during two different rounds of play. Cards are cleared from the screen by matching the face-up card on the deck with a face-up card in the “Summits” that is one position higher or lower. </P>
<P class='gametips'><FONT class=jtitre>Sum 21</FONT> <BR>The object of Sum 21 is, during three rounds of play, to “build” five piles of cards that each add up to 21, without going over. . Cards are worth their rank value, face cards are considered to be worth 10, Aces can be 11 or one.<BR></P></div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td nowrap class="rate">Kayla 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink">  2004-07-22 23:19:33</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">I like solitaire because is one classic game that everbody can enjoy!	<br>
                      </td>
                    </tr>
                    <tr>
...
<noscript>
analyse mesure frequentation internet par <img width="39" height="25" border=0 src="http://logv25.xiti.com/hit.xiti?s=159070&p=Game_Page-Solitaire&" title="Mesurez votre audience">
</noscript><!--//--></a></div></td>
  </tr>
</table>
