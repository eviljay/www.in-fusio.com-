...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=94#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=94", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1">Design, build and manage your ultimate zoo in this mobile version of the PC blockbuster hit! <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_94/image_02_jeu.gif" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=94','','width=250,height=250')"><img src="admin/Jeu/jeu_94/image_04_jeu.jpg" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=94','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">You are responsible for your animals happiness and must anticipate their needs; their desire to play, to have babies…The Zoo Tycoon 2 Mobile Photo feature lets you take photos of your animals, to build your own photo album and earn new game-related content.
<br><A href=http://www.in-fusio.com/zooty/ class=gamecopy   target=_blank >Click here to access to the Zoo Tycoon™ 2 Mobile Photo Objective bonus homepage.</A></div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>Choice between 3 zoo and 5 exhibits 
<LI class='gamefeatures'>A&nbsp;choice among a maximum of 8 animals (depending on&nbsp;the phones) 
<LI class='gamefeatures'>2 game modes: Freeform Mode and Zoo Photo Mode&nbsp;&nbsp; 
<LI class='gamefeatures'>A mobile game linked to the PC game,&nbsp; including downloadable and unlockable content</LI></UL> <br>
			    <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_94/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_94/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_94/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>How do I unlock new animals in the Mobile version?</FONT><BR>You need to keep your animals happy and make sure exhibits (with terrain and trees, etc.) so that your animals are happy and every exhibit has a money goal that you will meet if you keep your animals happy. The more happy your animals are, the more money you will earn! If you successfully finish your exhibit. </P>
<P class='gametips'><FONT class=jtitre>How do I get new Zoo Tycoon 2 PC content from playing on my mobile phone? <BR></FONT>By fulfilling all of the Photo Objectives in the Mobile version, you are given special access to the game’s web site. From there you can download bonus content for Zoo Tycoon 2 PC!</P>
<P class='gametips'><FONT class=jtitre>How do I use the cheat code my carrier gave to me?</FONT> <BR>Enter this code in the Mobile game (Options / Cheat) to access any of the following cheats. Each code gives a different bonus, so try them all. But be careful! Cheating in a game is the quickest way to ensure that you don\'t have fun.</P>
...
<tr>
          <td valign="top"><table width="497" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td rowspan="8">&nbsp;</td>
                <td colspan="3"><p><span class="rate">Rating</span><span class="newstitel"> </span><span class="gamefeatures">3                      Reviews </span></p>
                </td>
              </tr>
              <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td nowrap class="rate">Gage Taylor 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink"> (USA) 2004-11-27 02:52:57</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">I like the Zoo Tycoon 2 mobile it is great!	<br>
                      </td>
                    </tr>
                    <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td rowspan="4"><img src="images/spacer.gif" width="5" height="1"></td>
                      <td nowrap class="rate">Sarah 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink"> (Australia) 2004-11-27 00:02:25</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td width="100%" nowrap class="newsteaser"><table width="1%" border="0" cellspacing="2" cellpadding="0">
                        <tr>
                      <td><img src="images/p_etoile_pleine.gif" width="15" height="13"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">This game is such a good game! Its excellent	<br>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="6" class="text"><img src="images/spacer.gif" width="1" height="10"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink"> (UK) 2004-11-26 22:03:02</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td width="100%" nowrap class="newsteaser"><table width="1%" border="0" cellspacing="2" cellpadding="0">
                        <tr>
                      <td><img src="images/p_etoile_pleine.gif" width="15" height="13"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">Best, and only, tycoon game for your mobile. Totaly awsome, man.	<br>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="6" class="text"><img src="images/spacer.gif" width="1" height="10"></td>
