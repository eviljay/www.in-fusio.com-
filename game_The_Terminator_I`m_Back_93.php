<HTML>
<HEAD>
<TITLE>The Terminator I`m Back</TITLE>
...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=93#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=93", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">The Terminator I`m Back</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1"><P>In 2029 A.D. the machines rule the world. It\'s up to one man to save humanity’s future, if he can make it to the past.</P> <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_93/image_02_jeu.jpg" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=93','','width=250,height=250')"><img src="admin/Jeu/jeu_93/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=93','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy"><P class='gamecopy'>In Terminator I’m Back the action is better than ever. Fight the machines as the future-soldier Kyle Reese through a dozen different missions and recover the parts necessary to assemble the time displacement device which will send him back in time to save Sarah Connor. </P></div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>A game play mixing action and adventure 
<LI class='gamefeatures'>Sequel of the successful Terminator licensed game for mobile 
<LI class='gamefeatures'>Closely follows the movie’s original atmosphere and scenario</LI></UL> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=93','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_93/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_93/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_93/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>What is the purpose of the human resistance fighters I meet during the missions?</FONT></P>
<P class='gametips'>The human resistance fighters will attack Terminators and other Machines in order to help clear your way through a mission. But you should also try to protect them : the more humans that survive, the more points you get. </P>
<P class='gametips'><FONT class=jtitre>What is the use of the crawling type of movement?</FONT></P>
<P class='gametips'>More powerful weapons such as the Plasma Cannon come with very limited ammunition. You should save such weapons for the tougher enemies and to use the more common weapons whenever possible.</P></div>
...
<tr>
	  ...
	  <tr>
        <td><blockquote>
        <div align="center" class="copyright">The Terminator ™ and © 1984, 2004 Studio Canal Image S.A. f/k/a Canal+ D.A. All rights reserved. Terminator is a trademark of StudioCanal Image S.A. f/k/a Canal+ D.A. © In-Fusio 2004</div>
        <br>
&nbsp;</blockquote></td>
    </tr>
	  <tr>
...
hsi += '&p=Game_Page-The+Terminator+I%60m+Back';
...
<noscript>
analyse mesure frequentation internet par <img width="39" height="25" border=0 src="http://logv25.xiti.com/hit.xiti?s=159070&p=Game_Page-The+Terminator+I%60m+Back&" title="Mesurez votre audience">
</noscript><!--//--></a></div></td>
  </tr>
</table>
