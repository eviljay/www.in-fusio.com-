<HTML>
<HEAD>
<TITLE>Tomb Raider : Elixir of Life</TITLE>
...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=117#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=117", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Tomb Raider : Elixir of Life</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1">Lara Croft must infiltrate a scottish castle and discover who is her mysterious employer. <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_117/image_02_jeu.gif" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=117','','width=250,height=250')"><img src="admin/Jeu/jeu_117/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=117','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">Lara Croft must overcome state of the art security systems and an army of lethal defense robots before she can stop her employer from realizing his plan.</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>Great adventure game 
<LI class='gamefeatures'>More than 15 levels !</LI></UL> <br>
			   On ExEn handsets only <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=117','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_117/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_117/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_117/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>What means the character code of the items collected ?<BR></FONT>All items picked up in the game have a 6 character code associated with them. The codes associated with each item in Lara’s possession can be found by selecting the Item Info option on the main menu. By entering the codes on this web page, you can find out more details about each item.</P>
<P class='gametips'><FONT class=jtitre>What means the map code after each levels ?</FONT><BR>All maps’level finished in the game have a 6 character code associated with them. The codes associated with each map can be found by selecting the Level Menu on the main menu. By entering the codes on this web page, you will be able to view in full the complete map of the level you have finished.</P></div>
...
<tr>
	  ...
	  <tr>
        <td><blockquote>
        <div align="center" class="copyright">Core, Lara Croft and Tomb Raider are registered Trademarks of Core Design Limited. Eidos and the Eidos logo are trademarks of Eidos Limited. All rights reserved. © IN-FUSIO, 2005</div>
        <br>
&nbsp;</blockquote></td>
    </tr>
	  <tr>
...
hsi += '&p=Game_Page-Tomb+Raider+%3A+Elixir+of+Life';
...
<noscript>
analyse mesure frequentation internet par <img width="39" height="25" border=0 src="http://logv25.xiti.com/hit.xiti?s=159070&p=Game_Page-Tomb+Raider+%3A+Elixir+of+Life&" title="Mesurez votre audience">
</noscript><!--//--></a></div></td>
  </tr>
</table>
