<HTML>
<HEAD>
<TITLE>Midtown Madness® 3 Mobile 3D version</TITLE>
...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=105#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=105", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
      ...
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Midtown Madness® 3 Mobile 3D version</TD>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_105/image_02_jeu.gif" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=105','','width=250,height=250')"><img src="admin/Jeu/jeu_105/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=105','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
            ...
            <td width="46%" valign="top" class="text"><div class="gamecopy">Have all the excitement, the action, the danger, the how–can–we–say–it…the MADNESS of Midtown Madness 3 for XBOX in your hands. Wreak maximum havoc for maximum score as you race against the clock, AI vehicles!</div>
              ...
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>Top notch 3D engine with rear camera view – Look &amp; Feel of the original game ! 
<LI class='gamefeatures'>Game featuring Mini (BMW licensed car) like in Xbox version 
<LI class='gamefeatures'>Special 3D version:&nbsp; Impressive graphics / fast &amp; fluid animations </LI></UL> <br>
			    <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_105/image_05_jeu.bmp" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_105/image_06_jeu.bmp" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_105/image_07_jeu.bmp" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>The Opponent AI is too fast and I cannot keep up, how can I beat them?</FONT></P>
<P class='gametips'>Every level has shortcuts that will help you shave seconds off of your total race time, look for them! Once you\'ve found them, use the shortcuts, learn to use the mini-map, and memorize the levels: herein lie the keys to victory! Also, try playing the game to unlock all of the vehicles; the faster the vehicle you drive, the less advantage the A.I. have!</P>
<P class='gametips'><FONT class=jtitre>My car is really fast but I cannot take turns without hitting buildings! What can I do?</FONT></P>
<P class='gametips'>Each car has it\'s own unique physics and handling properties, so learning how to drive one car well isn\'t enough. With faster cars Practice and Timing are essential! Practice to learn the routes and levels, and time your turns to make maximum use of the handbrake feature. Watch out for the traffic!!</P>
<P class='gametips'><FONT class=jtitre>The game seems really hard! Is there a difficulty setting?</FONT></P>
<P class='gametips'>The Midtown Madness 3 Mobile team spent a lot of time to tune the game for players of all skill levels and ages in effort to offer the most depth of play and fun in any mobile racing game! The game was purposefully created to offer players of all skill levels a fun &amp; challenging experience, with the difficulty setting built directly into the game! So, don\'t worry &amp; keep practicing; soon you\'ll be driving like the pros!</P>
