...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=10#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=10", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Chicago Guns</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1"><STRONG>Let’s fight the mafia!</STRONG> <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_10/image_02_jeu.gif" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=10','','width=250,height=250')"><img src="admin/Jeu/jeu_10/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=10','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy"><P class='gamecopy'><FONT class='gamecopy'><FONT class='gamecopy'>You are the only one who can save the town from the corruption and the racket. You are one of the incorruptible detectives of Chicago. From the henchman to the godfather, you will have to eliminate everyone. Let’s fight the mafia!</FONT></FONT></P></div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>
<DIV class='gamefeatures'><FONT class='gamefeatures'><FONT class='gamefeatures'>An addictive shoot them up game</FONT></FONT></DIV>
<LI class='gamefeatures'>
<DIV class='gamefeatures'><FONT class='gamefeatures'><FONT class='gamefeatures'>An oppressive underworld atmosphere</FONT></FONT></DIV>
<LI class='gamefeatures'>
<DIV class='gamefeatures'>Different missions in a limited time: kill a certain number of enemies, free hostages</DIV></LI></UL> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=10','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_10/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_10/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_10/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td class="text"><br>
              <FONT class=jtitre>
<P class='gametips'><BR>How can I&nbsp;gain a&nbsp;life ?<BR></FONT>You&nbsp;gain a life every 5000 points.</P>
<P class='gametips'><FONT class=jtitre>How can I shoot the enemies ?<BR></FONT>Targets appear on three windows on the screen. The (4), (5) and (6) keys are used to shoot each of the targets.</P>
...
<noscript>
analyse mesure frequentation internet par <img width="39" height="25" border=0 src="http://logv25.xiti.com/hit.xiti?s=159070&p=Game_Page-Chicago+Guns&" title="Mesurez votre audience">
</noscript><!--//--></a></div></td>
  </tr>
</table>
