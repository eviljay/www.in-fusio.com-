...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=120#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=120", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Die Hard</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1">Based on the famous `Die Hard` blockbuster movie. <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_120/image_02_jeu.gif" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=120','','width=250,height=250')"><img src="admin/Jeu/jeu_120/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=120','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">Poorly equipped, heavily outnumbered and completely outgunned you assume the role of John McClane in your fight against the terrorists. Are you ready to embark on an explosive adventure featuring as much intrigue, suspense and drama as the film ‘Die Hard’?</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>Famous licence of the blockbuster movie. 
<LI class='gamefeatures'>Huge success of the Playstation and PC Games Die Hard. 
<LI class='gamefeatures'>Follow exactly the script of the movie.</LI></UL> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=120','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_120/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_120/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_120/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>How do the primary objectives work?</FONT><BR>In order to proceed to the next level, you have a number of main objectives. These objectives are listed at the beginning of each level by Sgt. Powell but they can also be viewed by pressing the Right Soft Key.</P>
<P class='gametips'><FONT class=jtitre>How do I proceed from one level to another?</FONT><BR>When all hostages on a floor has been freed and all bombs on the floor has been disarmed, an elevator will open and take you to the next level. A level in the game is the equivalent to a floor in the building.</P>
<P class='gametips'><FONT class=jtitre>How does the ‘disarm bomb’ mini game work?</FONT><BR>To disarm a bomb, you have to connect the two blinking circuits from left to right. You must press the corresponding key number to turn the tumbler before the time is up (otherwise the bomb goes off and current mission is failed).</P></div>
...
<tr>
	  ...
	  <tr>
        <td><blockquote>
        <div align="center" class="copyright">™ & © 2005, Fox Inc. All rights reserved. © 2005, Mobile Scope AG</div>
        <br>
&nbsp;</blockquote></td>
    </tr>
	  <tr>
...
<noscript>
analyse mesure frequentation internet par <img width="39" height="25" border=0 src="http://logv25.xiti.com/hit.xiti?s=159070&p=Game_Page-Die+Hard&" title="Mesurez votre audience">
</noscript><!--//--></a></div></td>
  </tr>
</table>
