...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=61#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=61", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Sphere Madness</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1">Be&nbsp;as skillful as you can to avoid the traps and to&nbsp;gain a maximum of points <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_61/image_02_jeu.jpg" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=61','','width=250,height=250')"><img src="admin/Jeu/jeu_61/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=61','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">You&nbsp;must move&nbsp;the ball through 40 levels. For each level you will have a limited time to get a maximum of bonuses and to find the way out whilst avoiding enemies.</div>
              <strong><br>
              Features:</strong><br>
              <P class='gamefeatures'>&nbsp;</P>
<UL>
<LI class='gamefeatures'>Great graphics<BR>
<LI class='gamefeatures'>Variety of gameplay (different items, objects, secret areas…)<BR>
<LI class='gamefeatures'>Top level design (the difficulty level increases throughout the game)</LI></UL> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=61','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_61/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_61/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_61/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>What are the different bonuses you can find in the game ?<BR></FONT></P>
<P class='gametips'>There are 7 types of bonus&nbsp;and to stimulate the bonuses the ball has to touch them. They are&nbsp;randomly located in&nbsp;the game and disappear with time.<BR></P>
<UL>
<LI class='gametips'>Bonus H (health) : max health
<LI class='gametips'>Bonus L (life) : get an extra life
<LI class='gametips'>Bonus P (points) : add 25 points
<LI class='gametips'>Bonus T (Time) : freeze health</LI></UL>
<P class='gametips'><FONT class=jtitre>What is \"Oracle\" used for ?<BR></FONT><BR>\"Oracle\" lets you buy some extra lives, a map of the level, invulnerability or a health freeze , a move&nbsp;to the&nbsp;next level ...</P></div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td nowrap class="rate">SzReQ 
 </td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                      <td nowrap class="newslink">  2004-09-09 09:15:27</td>
                      <td><img src="images/spacer.gif" width="2" height="1"></td>
                    ...
                    <tr>
                      <td colspan="6" class="text">This game is the best...!!!! congratulation!!!	<br>
                      </td>
                    </tr>
                    <tr>
...
hsi += '&p=Game_Page-Sphere+Madness';
...
<noscript>
analyse mesure frequentation internet par <img width="39" height="25" border=0 src="http://logv25.xiti.com/hit.xiti?s=159070&p=Game_Page-Sphere+Madness&" title="Mesurez votre audience">
</noscript><!--//--></a></div></td>
  </tr>
</table>
