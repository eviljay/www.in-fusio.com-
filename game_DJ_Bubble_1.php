...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=1#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=1", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">DJ Bubble</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1"><STRONG>Enjoy all the buzz and atmosphere of a hot dance-club, and get them grooving!</STRONG> <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_1/image_02_jeu.gif" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=1','','width=250,height=250')"><img src="admin/Jeu/jeu_1/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=1','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy"><P class='gamecopy'><FONT class='gamecopy'>You are the Top World DJ, and clubbers flock to your dance floor! Your goal is to send clubbers into a twilight zone by putting 3 identical dancers together. Remember, the faster you are, the more points you’ll win! Get spinning! </FONT></P></div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'><STRONG>50 levels</STRONG> of increasing difficulty
<LI class='gamefeatures'>2 DJs, 4 dance floors, dozens of clubbers
<LI class='gamefeatures'>Bonus balls to help you achieve a higher score</LI></UL> <br>
			    <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_1/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_1/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_1/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>How can I improve my score?<BR></FONT>You have two ways to improve your score. </P>
<P class='gametips'>The first one is to make more identical dancers disappear at one time. To do this, group together as many identical dancers as you can and then throw a final one that’ll make all of them fall. </P>
<P class='gametips'>The second&nbsp;one is to clear the level as fast as you can!</P>
<P class='gametips'><FONT class=jtitre>How about&nbsp;bubbles that look different?<BR></FONT>Those bubbles are bonus balls. Hit them with a dancer and you will gain a special power. You have different specific powers:</P>
<UL>
<LI class='gametips'><B>I’m the best DJ:</B> This bonus allows you to see where the face will go before throwing it.
<LI class='gametips'><B>Void</B>: This bonus makes a bunch of faces disappear around the point it touches (a total of 6 faces can disappear.)
<LI class='gametips'><B>Happy Hour:</B> This bonus clears all the faces which are the same colour as the one touched.
<LI class='gametips'><B>Spotlight</B>: After getting this bonus, you&nbsp;can send a ball that clears everything on its way to the top.</LI></UL></div>
