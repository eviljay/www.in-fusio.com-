...
{
if ( gogog == 'r') {
window.open("popup_reviews.php?id_jeu=119#rate", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
} else {
window.open("popup_reviews.php?id_jeu=119", "", "toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=no, copyhistory=no, width=480, height=500, left=300, top=50");
}
}
    ...
    <td width="497" bgcolor="FFC92E"><table width="497" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><TABLE WIDTH=497 BORDER=0 CELLPADDING=0 CELLSPACING=0 background="images/bkg_ho_prod.gif">
          <TR>
            ...
            <TD ROWSPAN=3 class="titre">Perry Rhodan</TD>
      ...
      <tr><td><table width="497" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFC92E">
            <tr>
              <td width="27">&nbsp;</td>
              <td>
               <div align="left" class="gamett1">Join Perry Rhodan on his journey into space and build collonies in far distant worlds. <br>
&nbsp;</div></td>
              <td width="15">&nbsp;</td>
            </tr>
          </table></td>
...
<TABLE WIDTH=240 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR>
    <TD width="240" height="184" valign="top" bgcolor="#FFC930"><img src="admin/Jeu/jeu_119/image_02_jeu.gif" border=0></TD>
  </TR>
  <TR>
        ...
        <TR>
          ...
          <TD width="203" height="0" ROWSPAN=2 valign="top" background="images/bkg_tab.gif"><TABLE  BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
              ...
              <TR>
                ...
                <TD align="center" bgcolor="#FFFFFF"><a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=119','','width=250,height=250')"><img src="admin/Jeu/jeu_119/image_04_jeu.gif" border=0></a></TD>
              ...
              <TR>
                ...
                <TD bgcolor="#FFFFFF">
                  <div align="center" class="text"><a href="#" class="readmore" onClick="MM_openBrWindow('game_demo.php?id_jeu=119','','width=250,height=250')">Play demo !</a></div>
                </TD>
  ...
  <TR>
    <TD valign="top"> <IMG SRC="images/mglob_03.gif" WIDTH=240 HEIGHT=49 /></TD>
              ...
              <td width="2%">&nbsp;</td>
            <td width="46%" valign="top" class="text"><div class="gamecopy">Join famous space-traveller Perry Rhodan on his journey to the stars. Your task is to build new human colonies on distant planets and defend them against extra-terrestrial threats.</div>
              <strong><br>
              Features:</strong><br>
              <UL>
<LI class='gamefeatures'>Great presentation 
<LI class='gamefeatures'>8-10 hours of complex gameplay 
<LI class='gamefeatures'>PC-like strategy-game&nbsp;</LI></UL> <br>
			    <br>
             
              <blockquote>
              <p>            <a href="#" onClick="MM_openBrWindow('game_demo.php?id_jeu=119','','width=250,height=250')">  <img src="images/playdemo.gif" width="149" height="26" border=0>   </a>         <br>
                <br>
	  ...
	  <tr>
        <td align="center">
          <p><img src="admin/Jeu/jeu_119/image_05_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_119/image_06_jeu.gif" border=0>&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin/Jeu/jeu_119/image_07_jeu.gif" border=0></p>
      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td><table width="497" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="text"><br>
              <P class='gametips'><FONT class=jtitre>How many levels are in the game?<BR></FONT>24 missions have to be accomplished.</P>
<P class='gametips'><FONT class=jtitre>How many upgrades can be found?</FONT><BR>A total of 35 upgrades can be found.</P>
<P class='gametips'><FONT class=jtitre>How does the game save?</FONT><BR>The game performs an auto-save every 5 minutes but you can also save your progress manually whenever you want.</P>
<P class='gametips'><FONT class=jtitre>It`s a RTS. Is it user-friendly?</FONT><BR>The game aids players through the first missions using a easy to understand tutorial-mode.</P></div>
...
<tr>
	  ...
	  <tr>
        <td><blockquote>
        <div align="center" class="copyright">© 2004, Perry Rhodan is published by Pabel-Moewig KG, Rastatt, Germany; © 2004 Chromatrix GmbH</div>
        <br>
&nbsp;</blockquote></td>
    </tr>
	  <tr>
...
<noscript>
analyse mesure frequentation internet par <img width="39" height="25" border=0 src="http://logv25.xiti.com/hit.xiti?s=159070&p=Game_Page-Perry+Rhodan&" title="Mesurez votre audience">
</noscript><!--//--></a></div></td>
  </tr>
</table>
